...
const Header = (props) => {
    ...
    const userNameN = sessionStorage.getItem('userName')
    ...
    useEffect(() => {
        ...
        if (roleUser === "USER") {
            const fetchApi1 = async (accountId, accessToken) => {
                try {
                    let res1 = await service.getCart(accountId, accessToken);
                    if (res1.length !== 0) {
                                    ...
                                    <div className="header-control-inner">
                                        <div className="meta-dreaming">
                                            ...
                                            <div className="menu-item block-user block-dreaming kodory-dropdown">
                                                <Link className="block-link" to={`/account/${userId}`}>
                                                ...
                                                {roleUser ? (
                                                    ...
                                                    <ul className="sub-menu">
                                                        <li className="menu-item kodory-MyAccount-navigation-link kodory-MyAccount-navigation-link--edit-account">
                                                            <span style={{ color: 'red' }}>{userNameN}</span>
                                                        </li>

                                                        <li className="menu-item kodory-MyAccount-navigation-link kodory-MyAccount-navigation-link--edit-account">
                                                            <Link to={`/account/${userId}`}>Account details</Link>
                                                        </li>
                                                        <li className="menu-item kodory-MyAccount-navigation-link kodory-MyAccount-navigation-link--customer-logout">
                                                            <Link to={'/login'}

                                                                style={{ cursor: 'pointer' }} onClick={() => handleLogout()}>Logout</Link>
                                                        </li>
                                                    </ul>
                                                ) : (
                                                    <ul className="sub-menu">
                                                        ...
                                                        <li className="menu-item kodory-MyAccount-navigation-link kodory-MyAccount-navigation-link--customer-logout">
                                                            <Link to={'/login'}
                                                                ...
                                                                style={{ cursor: 'pointer' }}>Login</Link>
                                                        </li>
                                                    </ul>
                                                )}
                                            </div>
                                            {roleUser === "USER" ? (
                                                ...
                                                <div className="block-minicart block-dreaming kodory-mini-cart kodory-dropdown">
                                                    <div
                                                        ...
                                                        data-kodory="kodory-dropdown"
                                                    >
                                                        <Link to={"/cart"} className="block-link link-dropdown">
                                                ...
                                                <div className="block-minicart block-dreaming kodory-mini-cart kodory-dropdown">
                                                    <div
                                                        ...
                                                        data-kodory="kodory-dropdown"
                                                    >
                                                        <Link to={"/login"} className="block-link link-dropdown">
                                                            <span><IoCartOutline /></span>
                            ...
                            <div className="meta-dreaming">
                                <div className="menu-item block-user block-dreaming kodory-dropdown">
                                    ...
                                    <ul className="sub-menu">
                                        ...
                                        <li className="menu-item kodory-MyAccount-navigation-link kodory-MyAccount-navigation-link--customer-logout">
                                            <a onMouseEnter={(e) => e.target.style.backgroundColor = 'black'} // Thay đổi màu nền khi hover
